/*
 ...
 Live project url: thehanno.herokuapp.com
*/
...
function panoramio_img(LAT, LONG, place){ //THIS DOESN'T WORK ANYMORE AS OF 13TH JUN, 2017
	...
	$.ajax({
		...
		error: function(){
			...
			$("#pictures").html("");
			$("#pictures").append("<p>Panoramio is shutdown so this functionality is down for the moment. I am working hard to get it back up and running</p>")
			$("#pictures").append("<p>Chuksy (13/06/17)</p>")
		},
		success: function(data){
